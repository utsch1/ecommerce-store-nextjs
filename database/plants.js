...
export const plants = [
  {
    ...
    price: 24.99,
    description:
      'Alocasia Cucullata is a rare Aroid with arrowhead-shaped foliage in an amazing metallic blue colour. If you want to keep this Alocasia happy, you should keep it in a very well aerated potting mix that dries out completely between waterings. If you prefer making potting mixes yourself, the best mix would be very light on peat moss, but with addition of sand, perlite and bark.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    price: 19.99,
    description:
      'Philodendron Red Cherry is a new and highly decorative variety with glossy foliage that changes colour! New leaves emerge a bright red fading into burgundy and eventually mature to green. If you love colourful Aroids, then this plant is your perfect match! Philodendron Red Sun is a climber and can grow quite tall, so it will love you for giving it a pole on its way up! ',
  },
  {
    id: 4,
